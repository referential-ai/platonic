...
## Local voice activation and device proof

Voice is optional and uses explicit local model and device configuration. Start with the [voice operations page](../operations/voice/), which links the detailed source-owned device and timing proof instead of copying it here.

## Next guides

Continue with [daily operation](../operations/) or the [Developer guide](../../developer/).
