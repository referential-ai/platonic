...
check_metadata() {
  ...
  jq -e '
    ...
    | ($release["product-version"] == "0.2.2")
      and ($release["product-tag"] == "platonic-v0.2.2")
  ...
  printf 'release metadata: product=0.2.2 tag=platonic-v0.2.2 channel=bundles public-code=platonic-core\n'
}
