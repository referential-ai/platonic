...
check_metadata() {
  ...
  jq -e '
    ...
    | ($release["product-version"] == "0.1.0")
      and ($release["product-tag"] == "platonic-v0.1.0")
  ...
  printf 'release metadata: product=0.1.0 tag=platonic-v0.1.0 channel=bundles public-code=platonic-core\n'
}
